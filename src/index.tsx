    ...
    <StrictMode>
        ...
        <div id="main">
            <section id="section_1" className="introduce">
                ...
                <p>web開発やドラムをしている高専生です.いつもはNITTCの同学年でやっている<a href="https://github.com/tokuyama-it" target="_blank">ITをむさぼる会</a>で活動をしています. TypeScriptとRustを勉強中です.
                </p>
            </section>
            <section id="section_2" className="education">
                ...
                <ul>
                    ...
                    <li>2019年〜現在 徳山工業高等専門学校 情報電子工学科 在学中</li>
                </ul>
            </section>
